...
# Create the delegated roles for the end-to-end security model
# That is, the 'developer-signed' and 'recently-developer-signed' roles. 
developer_signed_pub = import_ed25519_publickey_from_file("keystore/developer-signed.pub")
repository.targets.delegate("developer-signed", [developer_signed_pub], [], restricted_paths=["repository/targets/packages/"])
...
recently_developer_signed_pub = import_ed25519_publickey_from_file("keystore/recently-developer-signed.pub")
repository.targets.delegate("recently-developer-signed", [recently_developer_signed_pub], [], restricted_paths=["repository/targets/packages/"])
...
# Create the PEP 458 'pypi-signed' role.
