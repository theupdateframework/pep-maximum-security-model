...
# The keys for the non-root top level roles and three delegated roles
# (pypi-signed, developer-signed, recently-developer-signed)
...
generate_and_write_ed25519_keypair('keystore/developer-signed', password='pw')
generate_and_write_ed25519_keypair('keystore/recently-developer-signed', password='pw')

# The keys for the 'developer-signed' roles.
generate_and_write_ed25519_keypair('keystore/requests', password='pw')
generate_and_write_ed25519_keypair('keystore/numpy', password='pw')
